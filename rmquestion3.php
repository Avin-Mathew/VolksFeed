...
<!<frameset cols="70%">	
<form name=pgm1 method=POST action="rmquestion4.php">
...
$sql = "select question from tbl_question where tname='$q2' and status='enable'";
echo "Select question to remove:<select name='suqn'>";
...
echo "<input type='submit' name='clk2' value='remove selected question'>";	
?>
