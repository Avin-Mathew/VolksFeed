...
$sql = "select tname from topic where category='$q'";
echo "select topic to add question:<select name='sutopic'>";
...
echo "<input type='text' name='txt1' required='yes'>";
echo "<input type='submit' name='clk2' value='ADD question'>";
echo "<input type='hidden' name='txt3' value=$q>";
?>
