...
<!<frameset cols="70%">	
<form name='user_reg' method='POST' action='user_home.php'>
		...
		<!------start-768px-menu---->
			...
			<div>
				...
				<div class="header-left">
					<div class="logo"><a href="http://server.nirmalamca.com/PRJ14/pgroup1403/FMS/user_home.php">VolksFeed</a></div>
				</div>
				<div class="header">
