...
<!<frameset cols="70%">					
<form name=pgm1 method=POST action="user_home2.php">
	...
	<body>
		...
		<!------start-768px-menu---->
			...
			<div class="content">
					<div class="about">
						<div class="wrap">
						<center><b><i><font size="30">Select Topic</font></i></b><br><br>
...
$sql = "select distinct category from tbl_question where status='enable'";
